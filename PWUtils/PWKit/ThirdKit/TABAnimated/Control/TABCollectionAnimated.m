...
- (void)registerViewToReuse:(UIView *)view {
    ...
    for (Class class in self.cellClassArray) {
        ...
        NSBundle *bundle = [NSBundle bundleWith:class fileName:classString fileType:@"nib"];
        //        NSString *nibPath = [TABXibBundleWithClass(class) pathForResource:classString ofType:@"nib"];
        NSString *nibPath = [bundle pathForResource:classString ofType:@"nib"];
        
        if (nil != nibPath && nibPath.length > 0) {
            [collectionView registerNib:[UINib nibWithNibName:classString bundle:bundle] forCellWithReuseIdentifier:[NSString stringWithFormat:@"tab_%@",classString]];
            [collectionView registerNib:[UINib nibWithNibName:classString bundle:bundle] forCellWithReuseIdentifier:classString];
